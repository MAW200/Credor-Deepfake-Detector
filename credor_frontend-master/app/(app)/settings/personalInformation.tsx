...
export default function PersonalInformationScreen() {
  ...
  const handleChangeDateOfBirth = () => {
    Alert.alert("Coming Soon", "Date of Birth change functionality will be available soon.");
  };
        ...
        <SafeAreaView>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.fieldContainer}>
              ...
              <TouchableOpacity onPress={handleChangeName} style={styles.changeButton}>
            ...
            <View style={styles.fieldContainer}>
              ...
              <TouchableOpacity onPress={handleChangeEmail} style={styles.changeButton}>
                <Text style={styles.changeText}>Change</Text>
              </TouchableOpacity>
            </View>
            ...
            <View style={styles.fieldContainer}>
              ...
              <TouchableOpacity onPress={handleChangeDateOfBirth} style={styles.changeButton}>
                <Text style={styles.changeText}>Change</Text>
              </TouchableOpacity>
            </View>
          </View>
